...
If your template only has `AGENTS.md` and `claude` is in your clients list, AllAgents automatically creates a symlink:

```
CLAUDE.md -> AGENTS.md
```

This ensures Claude always has its instruction file without duplicating content.
