...
const RECOMMENDED_SOURCE_ENTRIES: readonly SkillCatalogSource[] = Object.freeze(
  [
    ...
    source({
      sourceId: 'elastic-docs-skills',
      repo: 'elastic/elastic-docs-skills',
      effectiveRef: 'main',
      approvedRoot: 'skills',
      installRoot: '.',
      installSource: 'elastic/elastic-docs-skills@main',
      displayName: 'Elastic Docs Skills',
      description: 'Documentation skills maintained by Elastic.',
      category: 'documentation',
      homepage: 'https://elastic.github.io/elastic-docs-skills/',
      author: { name: 'Elastic', url: 'https://github.com/elastic' },
